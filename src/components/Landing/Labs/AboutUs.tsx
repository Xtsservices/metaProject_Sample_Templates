...
import { Beaker, Quote, Mail } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#" className="text-teal-600 font-semibold border-b-2 border-teal-600 pb-1">About Us</a>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-800 mb-8">About OUR STORY</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800">friendly and passionate</h2>
          </div>

          {/* Team Members */}
          <div className="space-y-20">
            {team.map((member, index) => (
              <div key={index} className={`grid lg:grid-cols-2 gap-12 items-center ${member.alignment === 'right' ? 'lg:flex-row-reverse' : ''}`}>
                {member.alignment === 'left' ? (
                  <>
                    <div className="relative">
                      <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-lg overflow-hidden h-96 flex items-center justify-center text-9xl">
                        {member.image}
                      </div>
                    </div>
                    <div>
                      <h3 className="text-3xl font-bold text-gray-800 mb-2">{member.name}</h3>
                      <p className="text-teal-600 font-semibold text-lg mb-6">{member.role}</p>
                  ...
                  <>
                    ...
                    <div className="relative">
                      <div className="bg-gradient-to-br from-cyan-400 to-blue-500 rounded-lg overflow-hidden h-96 flex items-center justify-center text-9xl">
                        {member.image}
                      </div>
                    </div>
                  </>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800">what client say about us</h2>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-500 to-cyan-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-block bg-white/10 backdrop-blur-sm p-6 rounded-2xl mb-8">
            ...
            <button className="bg-white text-teal-600 px-10 py-4 rounded-full hover:bg-gray-100 transition font-semibold text-lg shadow-lg">
              CONTACT US
            </button>
          </div>
        </div>
