    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-6 lg:p-8">
      <div className="max-w-none space-y-4 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
          {/* Total Invites */}
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-2xl p-4 sm:p-6 text-white relative overflow-hidden border border-blue-400 dark:border-white">
          ...
          {/* Total Customers */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm relative border border-gray-200 dark:border-white">
            <div className="flex items-start justify-between mb-4">
            ...
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-1">2,102</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Since Last Week</p>
          </div>

          {/* Total Orders */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm relative sm:col-span-2 xl:col-span-1 border border-gray-200 dark:border-white">
            <div className="flex items-start justify-between mb-4">
              <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Total Orders</p>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-1">2,458</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Since Last Week</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-4 sm:gap-6">
          {/* Sales Analytics (2fr) */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Sales Analytics</h3>
              <select className="text-sm border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1.5 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-700 w-full sm:w-auto">
          ...
          <div className="space-y-4 sm:space-y-6">
            {/* Banner */}
            <div className="bg-gradient-to-r from-gray-400 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-2xl p-4 sm:p-6 text-white relative overflow-hidden h-40 sm:h-48 border border-gray-300 dark:border-white">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
                <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white">Top Selling</h3>
                <select className="text-sm border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1.5 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-700 w-full sm:w-auto">
                  <option>This Month</option>
                </select>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 gap-3 sm:gap-0">
            <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Latest Orders</h3>
            <button className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium self-start sm:self-auto">View All</button>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-100 dark:border-gray-700">
                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-300">Order Id</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-300">Medicine Name</th>
                ...
                <tbody>
                  {filteredOrders.map((order) => (
                    <tr key={order.id} className="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="py-4 px-4 text-sm text-gray-900 dark:text-gray-100">{order.id}</td>
                      <td className="py-4 px-4 text-sm text-gray-900 dark:text-gray-100">{order.medicine}</td>
                      <td className="py-4 px-4 text-sm text-gray-900 dark:text-gray-100">{order.price}</td>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white">Completed Payment</span>
              </div>
              <MoreVertical className="w-4 h-4 text-gray-400 dark:text-gray-500" />
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Revenue: $25,000</p>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-1">200</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Since Last Week</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white">Pending Payments</span>
              </div>
              <MoreVertical className="w-4 h-4 text-gray-400 dark:text-gray-500" />
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Revenue: $10,000</p>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-1">40</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Since Last Week</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-sm border border-gray-200 dark:border-white">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-900 dark:text-white">Failed Payments</span>
              </div>
              <MoreVertical className="w-4 h-4 text-gray-400 dark:text-gray-500" />
            </div>
            <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Revenue: $5,000</p>
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-1">5</h2>
            <p className="text-xs text-gray-500 dark:text-gray-400">Since Last Week</p>
          </div>
        </div>
      </div>
